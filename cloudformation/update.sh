...
--parameters ParameterKey=EmailIdentityName,UsePreviousValue=true ParameterKey=NameOfRecipient,UsePreviousValue=true \
ParameterKey=S3BucketName,UsePreviousValue=true ParameterKey=HostedZoneName,UsePreviousValue=true \
ParameterKey=ZoneID,UsePreviousValue=true